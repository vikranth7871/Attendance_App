...
import { LogOut, LayoutDashboard, Users, BookOpen, UserPlus, Settings, Activity, GraduationCap, X, Globe, Calendar, UserCheck } from 'lucide-react';
...
const AdminSidebar = ({ isOpen, setIsOpen }) => {
    ...
    const links = [
        ...
        { name: 'Teacher Attendance', path: '/admin/teacher-attendance', icon: <UserCheck size={20} /> },
        { name: 'Teacher Leaves', path: '/admin/teacher-leaves', icon: <Calendar size={20} /> },
