  ...
  return (
    <View className="flex-1 bg-gray-900 p-6 pt-16">
      <View className="flex-row justify-between items-center mb-8">
        <View>
          <Text className="text-white text-2xl font-bold">Student Dashboard</Text>
      ...
      <View className="bg-gray-800 p-6 rounded-[24px]">
        <Text className="text-white text-lg">Student modules will be implemented in Phase 5.</Text>
      </View>
    </View>
  );
}
