...
const LEAVE_TYPES = [
  {
    id: 'Casual',
    label: 'Casual Leave',
    desc: 'General short-term leave for personal commitments',
    icon: Calendar,
    color: '#818cf8',
  },
  {
    ...
    desc: 'Medical conditions, illness, or doctor appointments',
    icon: HeartPulse,
    color: '#ec4899',
  },
  {
    id: 'Earned',
    label: 'Earned Leave',
    desc: 'Privilege leave accrued from service tenure',
    icon: Award,
    color: '#f59e0b',
  },
  {
    id: 'Duty',
    label: 'On-Duty / Official',
    desc: 'Institutional duties, conferences, or official tasks',
    icon: Briefcase,
    color: '#10b981',
  },
  {
    id: 'Other',
    label: 'Other',
    desc: 'Special or emergency circumstances requiring leave',
    icon: ShieldAlert,
    color: '#a855f7',
  },
];
...
const TeacherApplyLeaveScreen = ({ navigation }) => {
  ...
  const fetchLeaves = async (quiet = false) => {
    ...
    try {
      ...
      console.error('Teacher leaves fetch error:', err);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (attachment) {
        if (Platform.OS === 'web') {
          // On Web, append native File or Blob directly to FormData
      ...
      showFeedback('success', 'Leave application submitted successfully for Admin review!');
      setStartDate('');
      setEndDate('');
      setReason('');
      setAttachment(null);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <Header
        ...
        subtitle="Submit leave applications for administrative approval"
        showBack
        ...
        {activeTab === 'new' ? (
          ...
          <View style={[styles.mainCard, shadows.md]}>
            ...
            <View style={styles.formFieldGroup}>
              ...
              {/* Nested Calendar Picker Container (Matches Web Design) */}
              <View style={styles.calendarContainer}>
                ...
                <View
                  style={[
                    ...
                    calendarMode === 'single' && { gridTemplateColumns: '1fr' },
                  ]}
                >
            ...
            {loading ? (
              ...
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySubtitle}>
                  Submit a new request to track administrative approval here.
                </Text>
                <TouchableOpacity
                ...
                {filteredLeaves.map((l) => {
                  ...
                  return (
                    <View key={l.id || l._id} style={styles.leaveHistoryCard}>
                      ...
                      {(l.documentUrl || l.document_url) && (
                        <TouchableOpacity
                          style={styles.viewDocButton}
                          onPress={() => {
                            setPreviewDocUrl(l.documentUrl || l.document_url);
                            setPreviewDocTitle(
