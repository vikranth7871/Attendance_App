...
const TeacherQuizManageScreen = ({ navigation }) => {
  ...
  const fetchSubjects = async () => {
    try {
      ...
      console.warn('Teacher fetchSubjects error, attempting fallback:', err);
    }
    ...
    try {
      ...
      console.warn('Fallback admin subjects error:', err);
    }
  };
  ...
  const uniqueSubjects = useMemo(() => {
    ...
    if (!seen.has('general')) {
      list.unshift({ id: '', _id: '', name: 'General', subject_name: 'General', subjectName: 'General' });
    }
    return list;
  }, [subjects]);
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      ...
      <Header
        ...
        subtitle="Manage & generate quizzes for your students"
        showBack
